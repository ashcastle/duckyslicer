    ...
    return {
        "ProjectArchive.kt": " ".join(
            (
                ...
                "PROJECT_ARCHIVE_SCHEMA_VERSION = 71",
        ...
        "ProjectStore.kt": " ".join(
            (
                ...
                'SCHEMA_VERSION = 73 schemaVersion >= 70 '
                'put("heightRangeModifiers", heightRangeModifiers.toProjectJson()) '
        ...
        "PROJECT_FORMAT.md": (
            "manifest.json models/000.stl schema version `71` "
            "Schema 1 through 71 projects remain readable brim chamfer policy up to 16 plates "
