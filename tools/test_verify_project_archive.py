    ...
    return {
        "ProjectArchive.kt": " ".join(
            (
                ...
                "PROJECT_ARCHIVE_SCHEMA_VERSION = 29",
        ...
        "ProjectStore.kt": " ".join(
            (
                ...
                'SCHEMA_VERSION = 31 put("role", role.name) put("config", config.toJson())',
            )
        ),
        ...
        "PROJECT_FORMAT.md": (
            "manifest.json models/000.stl schema version `29` "
            "Schema 1 through 29 projects remain readable up to 16 plates "
