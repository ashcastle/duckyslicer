    ...
    return {
        "ProjectArchive.kt": " ".join(
            (
                ...
                "PROJECT_ARCHIVE_SCHEMA_VERSION = 30",
        ...
        "ProjectStore.kt": " ".join(
            (
                ...
                'SCHEMA_VERSION = 32 put("role", role.name) put("config", config.toJson())',
            )
        ),
        ...
        "PROJECT_FORMAT.md": (
            "manifest.json models/000.stl schema version `30` "
            "Schema 1 through 30 projects remain readable up to 16 plates "
