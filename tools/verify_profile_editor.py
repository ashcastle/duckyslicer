...
def verify_profile_editor(sources: dict[str, str]) -> None:
    ...
    for marker in (
        ...
        "R.string.filename_format",
        "R.string.filename_format_hint",
        "R.string.filename_format_invalid",
        ...
        "R.string.prime_tower_position",
        "R.string.prime_tower_position_x",
        ...
        "R.string.custom_purge_multiplier",
        "R.string.purge_multiplier",
        "flushMultiplierOverrideEnabled = it",
        "flushMultiplier = it.roundToInt() / 100f",
        ...
        "R.string.template_custom_gcode",
        ...
        "R.string.minimum_extruding_rate",
        "R.string.minimum_travel_rate",
        "minimumExtrudingRate = it",
        "minimumTravelRate = it",
        "silentMinimumExtrudingRate = it",
        "silentMinimumTravelRate = it",
        ...
        "R.string.filament_notes",
        "R.string.configuration_notes",
        "R.string.pellet_flow_coefficient",
        "filamentDiameterFromPelletFlowCoefficient",
        ...
        "R.string.fan_speedup_time",
        "options.printerProfile.copy(fanSpeedupTime =",
        "R.string.fan_speedup_overhangs",
        "options.printerProfile.copy(fanSpeedupOverhangs =",
        "R.string.fan_kickstart",
        "options.printerProfile.copy(fanKickstart =",
    ...
    for source_name in ("strings.xml", "strings-ko.xml"):
        ...
        for resource in (
            ...
            'name="filename_format_hint"',
            'name="filename_format_invalid"',
            ...
            'name="prime_tower_position"',
            'name="prime_tower_position_x"',
            ...
            'name="pellet_extruder"',
            'name="pellet_flow_coefficient"',
