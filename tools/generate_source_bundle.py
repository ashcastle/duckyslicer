...
BUILD_INPUTS = (
    ...
    "native/slicer-runtime/arrange-preferred-position.patch",
    "native/slicer-runtime/silent-mode-machine-limits.patch",
    "native/slicer-runtime/machine-minimum-rates.patch",
    ...
    "native/slicer-runtime/height-range-color.patch",
    "native/slicer-runtime/auto-line-width.patch",
    "native/slicer-runtime/engine-height-range-import.patch",
    "native/slicer-runtime/engine-auto-width-segmentation.patch",
