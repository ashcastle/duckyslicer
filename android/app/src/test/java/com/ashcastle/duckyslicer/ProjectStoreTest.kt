...
class ProjectStoreTest {
    ...
    fun currentSchemaPersistsStableVolumeAndSchemaOneMigratesDeterministically() = withStore { root, store ->
        ...
        assertEquals(71, persisted.getInt("schemaVersion"))
        assertEquals(
        ...
        assertEquals(4.76f, restored.sliceOptions?.printerProfile?.nozzleHeight)
        assertEquals(143f, restored.sliceOptions?.printerProfile?.nozzleVolume)
        assertEquals(
            listOf(0f, 10.5f),
