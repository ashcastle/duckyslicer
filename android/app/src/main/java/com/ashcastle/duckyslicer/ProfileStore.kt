...
class ProfileStore internal constructor(
    ...
    private fun writePrinter(
        ...
        val profile = PrinterProfile(
            ...
            templateCustomGcode = options.printerProfile.templateCustomGcode,
...
internal fun QualityProfile.toProfileJson() = JSONObject()
    ...
    .put("flushMultiplierOverrideEnabled", multiMaterial.flushMultiplierOverrideEnabled)
    .put("flushMultiplier", multiMaterial.flushMultiplier)
...
internal fun JSONObject.toQualityProfileOrNull(): QualityProfile? = runCatching {
    QualityProfile(
        ...
        multiMaterial = MultiMaterialSettings(
            ...
            flushMultiplierOverrideEnabled = optBoolean("flushMultiplierOverrideEnabled"),
            flushMultiplier = optDouble("flushMultiplier", 0.3).toFloat(),
