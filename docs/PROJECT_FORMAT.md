...
schema version `14`, and stores the selected plate plus a bounded `plates` list. Each plate
...
Schema 1 through 11 projects remain readable and migrate deterministically to one plate.
