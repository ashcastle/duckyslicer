...
schema version `10`, and stores the selected plate plus a bounded `plates` list. Each plate
...
Schema 1 through 9 projects remain readable and migrate deterministically to one plate.
