...
Exports currently write profile schema 16. Bundle version 1 accepts supported profile
schemas 1 through 16 and applies the same safe defaults used for an older private
